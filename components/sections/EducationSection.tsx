...
export default function EducationSection() {
  return (
    <section
      id="education"
      className="max-w-4xl mx-auto px-4 py-16 min-h-screen scroll-mt-24"
    >
      <motion.h1
          ...
          >
            ...
            {e.focus && (
              <div className="mb-4">
                ...
                <p className="text-sm text-fg/80 pl-4 border-l-2 border-accent-primary/30">
                  {e.focus}
                </p>
              </div>
            )}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {e.coursework.map((course, courseIndex) => (
                    <div key={courseIndex} className="flex items-center text-sm text-fg/80">
